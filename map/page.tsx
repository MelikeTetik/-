...
import {
  ...
  AiOutlineDelete,
  AiOutlineDownload,
} from "react-icons/ai"; // React Icons'dan ikonlar
...
import { AnimatedSVGEdge } from "../map/AnimatedSVGEdge";
...
const MindMapPage = () => {
  ...
  const [isPanelOpen, setIsPanelOpen] = useState(true); // Panelin açık/kapalı durumu

  const images2 = [
    { id: "image1", src: "/img1.jpg", alt: "Image 1" },
    { id: "image2", src: "/img2.jpg", alt: "Image 2" },
    { id: "image3", src: "/arkaplan.jpg", alt: "Image 3" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        ...
        <button
          onClick={saveAsPng}
          title="Zihin Haritasını İndir"
          className="p-2  ml-2 "
          style={{ position: "absolute", top: "32px", left: "170px" }}
        >
          <BiSolidFilePng
            className="ml-2"
            style={{ color: "#668b8b", fontSize: "24px", padding: "0.1rem" }}
